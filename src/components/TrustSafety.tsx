export default function TrustSafety() {
  ...
  <section id="trust" className="py-24 lg:py-32 bg-white" aria-label="Trust & Safety section">
      <div className="site-container">
        <h2 className="font-montserrat font-extrabold text-3xl text-black mb-8 text-center drop-shadow">Security & Trust Framework</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="flex flex-col gap-4">
            <div className="inline-flex items-center gap-3">
              ...
              <span className="text-sm text-black font-semibold">Volunteer Verification (Planned)</span>
            </div>
            ...
            <div className="inline-flex items-center gap-3">
              ...
              <span className="text-sm text-black font-semibold">24/7 Support System (Planned)</span>
            </div>
            ...
            <div className="inline-flex items-center gap-3">
              ...
              <span className="text-sm text-black font-semibold">Privacy & Data Protection (Planned)</span>
            </div>
          </div>
          ...
          <div className="bg-white shadow rounded-lg p-8 min-h-[200px]">
            <div className="flex items-start gap-4">
              ...
              <div>
                <blockquote className="italic text-black text-left mb-2 font-bold">Our development team is implementing robust security measures and trust protocols to ensure safe interactions between pilgrims and volunteers.</blockquote>
                <span className="text-sm text-black font-semibold">— BandhuConnect+ Development Team</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white shadow rounded-lg p-8 min-h-[200px]">
            ...
            <ul className="list-disc pl-5 text-black text-sm font-medium">
              <li>Data encryption and privacy policy implementation</li>
              <li>Volunteer background verification system</li>
              <li>24/7 emergency support coordination</li>
            </ul>
          </div>
        </div>
      </div>
