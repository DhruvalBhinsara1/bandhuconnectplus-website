export default function CommunityImpact() {
  ...
  <section id="community" className="py-24 lg:py-32 bg-[#4A90E2]/10" aria-label="Community Impact section">
      <div className="site-container">
        <h2 className="font-montserrat font-extrabold text-3xl text-black mb-8 text-center drop-shadow">Community Impact Goals</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="font-semibold text-black">Target: 10,000+ Pilgrims Helped</span>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow p-6 min-h-[120px]">
              <div className="flex items-center gap-3">
                ...
                <span className="font-semibold text-black">Target: 2,000+ Volunteers</span>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow p-6 min-h-[120px]">
              <div className="flex items-center gap-3">
                ...
                <span className="font-semibold text-black">Target: 50+ Events Supported</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-8 min-h-[220px]">
            <div className="flex items-start gap-4">
              ...
              <div>
                <blockquote className="italic text-black text-left mb-2">We're currently in development phase, building the foundation for safe and connected pilgrim experiences at Mahakumbh Mela.</blockquote>
                <span className="text-sm text-black font-semibold">— BandhuConnect+ Team</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-8 flex flex-col gap-4 min-h-[260px]">
            <h3 className="font-bold text-lg">Interactive Impact Map</h3>
            <p className="text-black text-sm">Coming soon - Track volunteer locations and safe zones in real-time</p>
            <div className="mt-4 bg-gray-50 rounded border border-gray-200 h-36 flex items-center justify-center">Map placeholder</div>
            <h4 className="font-bold mt-4">Development Roadmap</h4>
            <p className="text-black text-sm">Planning partnerships with local organizers to establish safe-zone booths and volunteer coordination centers across the Mela grounds.</p>
          </div>
        </div>
      </div>
    </section>
